...
const peliculas = [
    ...
    { nombre: "Anabelle", descripcion: "John Form encuentra el regalo perfecto para Mia, su mujer embarazada: una preciosa muñeca 'vintage' llamada Annabelle. Una noche, una secta satánica les ataca brutalmente. Además, provocan que un ente maligno se apodere de Annabelle buscando este influir terror en sus victimas.", img: "https://pics.filmaffinity.com/Annabelle_Creation-137836637-large.jpg" }
];
